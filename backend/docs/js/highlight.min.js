...
;"object"==typeof exports&&"undefined"!=typeof module&&(module.exports=hljs);/*! `http` grammar compiled for Highlight.js 11.6.0 */
...
;hljs.registerLanguage("http",e)})();/*! `json` grammar compiled for Highlight.js 11.6.0 */
